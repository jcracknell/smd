...
class LiteralExpressionProductionsSpec extends ParsingScenarios {
  ...
  describe("string literals") {
    ...
    parsing("'\\x00z'")     as literalExpression should produce (StringLiteral("\u0000z"))
    ...
    parsing("'\\u0000z'")   as literalExpression should produce (StringLiteral("\u0000z"))
    parsing("'\\x0000z'")   as literalExpression should produce (StringLiteral("\u0000z"))
    parsing("'\\#u0000z'")  as literalExpression should produce (StringLiteral("\u0000z"))
    parsing("'\\#x0000z'")  as literalExpression should produce (StringLiteral("\u0000z"))
    parsing("'\\u0000;z'")  as literalExpression should produce (StringLiteral("\u0000z"))
    parsing("'\\x0000;z'")  as literalExpression should produce (StringLiteral("\u0000z"))

...
case class SequenceParser7[+T1, +T2, +T3, +T4, +T5, +T6, +T7](
  _1: Parser[T1], _2: Parser[T2], _3: Parser[T3], _4: Parser[T4], _5: Parser[T5], _6: Parser[T6], _7: Parser[T7]
) extends Product7[Parser[T1], Parser[T2], Parser[T3], Parser[T4], Parser[T5], Parser[T6], Parser[T7]]
     with Product
     with Parser[(T1, T2, T3, T4, T5, T6, T7)]
{
...
object SequenceParser7 {
  /** Implicit [[smd.parsing.SequencingHeuristic]] which can be used to combine an [[smd.parsing.SequenceParser7]]
    * and an [[smd.parsing.Parser]] into an [[smd.parsing.SequenceParser8]]. */
  implicit def sequencingHeuristic[T1, T2, T3, T4, T5, T6, T7, A]: SequencingHeuristic[
    /*  left: */ SequenceParser7[T1, T2, T3, T4, T5, T6, T7],
    /* right: */ Parser[A],
    /*  dest: */ SequenceParser8[T1, T2, T3, T4, T5, T6, T7, A]
  ] =
    SequencingHeuristic.create((l, r) => SequenceParser8(l._1, l._2, l._3, l._4, l._5, l._6, l._7, r))
}
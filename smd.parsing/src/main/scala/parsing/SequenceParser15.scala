...
import scala.{Product, Product15}
...
case class SequenceParser15[+T1, +T2, +T3, +T4, +T5, +T6, +T7, +T8, +T9, +T10, +T11, +T12, +T13, +T14, +T15](
  _1: Parser[T1], _2: Parser[T2], _3: Parser[T3], _4: Parser[T4], _5: Parser[T5], _6: Parser[T6], _7: Parser[T7], _8: Parser[T8], _9: Parser[T9], _10: Parser[T10], _11: Parser[T11], _12: Parser[T12], _13: Parser[T13], _14: Parser[T14], _15: Parser[T15]
) extends Product15[Parser[T1], Parser[T2], Parser[T3], Parser[T4], Parser[T5], Parser[T6], Parser[T7], Parser[T8], Parser[T9], Parser[T10], Parser[T11], Parser[T12], Parser[T13], Parser[T14], Parser[T15]]
     with Product
     with Parser[(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15)]
{
  def parse(context: ParsingContext): ParsingResult[(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15)] = {
    ...
    rb.success((r1.product, r2.product, r3.product, r4.product, r5.product, r6.product, r7.product, r8.product, r9.product, r10.product, r11.product, r12.product, r13.product, r14.product, r15.product))
  }
}

object SequenceParser15 {
  /** Implicit [[smd.parsing.SequencingHeuristic]] which can be used to combine an [[smd.parsing.SequenceParser15]]
    * and an [[smd.parsing.Parser]] into an [[smd.parsing.SequenceParser16]]. */
  implicit def sequencingHeuristic[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, A]: SequencingHeuristic[
    /*  left: */ SequenceParser15[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15],
    /* right: */ Parser[A],
    /*  dest: */ SequenceParser16[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, A]
  ] =
    SequencingHeuristic.create((l, r) => SequenceParser16(l._1, l._2, l._3, l._4, l._5, l._6, l._7, l._8, l._9, l._10, l._11, l._12, l._13, l._14, l._15, r))
}
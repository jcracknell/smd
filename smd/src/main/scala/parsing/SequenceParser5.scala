...
case class SequenceParser5[+T1, +T2, +T3, +T4, +T5](
  _1: Parser[T1], _2: Parser[T2], _3: Parser[T3], _4: Parser[T4], _5: Parser[T5]
) extends Product5[Parser[T1], Parser[T2], Parser[T3], Parser[T4], Parser[T5]]
     with Product
     with Parser[(T1, T2, T3, T4, T5)]
{
...
object SequenceParser5 {
  /** Implicit [[smd.parsing.SequencingHeuristic]] which can be used to combine an [[smd.parsing.SequenceParser5]]
    * and an [[smd.parsing.Parser]] into an [[smd.parsing.SequenceParser6]]. */
  implicit def sequencingHeuristic[T1, T2, T3, T4, T5, A]: SequencingHeuristic[
    /*  left: */ SequenceParser5[T1, T2, T3, T4, T5],
    /* right: */ Parser[A],
    /*  dest: */ SequenceParser6[T1, T2, T3, T4, T5, A]
  ] =
    SequencingHeuristic.create((l, r) => SequenceParser6(l._1, l._2, l._3, l._4, l._5, r))
}
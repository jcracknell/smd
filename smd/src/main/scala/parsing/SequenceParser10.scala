...
import scala.{Product, Product10}
...
case class SequenceParser10[+T1, +T2, +T3, +T4, +T5, +T6, +T7, +T8, +T9, +T10](
  _1: Parser[T1], _2: Parser[T2], _3: Parser[T3], _4: Parser[T4], _5: Parser[T5], _6: Parser[T6], _7: Parser[T7], _8: Parser[T8], _9: Parser[T9], _10: Parser[T10]
) extends Product10[Parser[T1], Parser[T2], Parser[T3], Parser[T4], Parser[T5], Parser[T6], Parser[T7], Parser[T8], Parser[T9], Parser[T10]]
     with Product
     with Parser[(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)]
{
...
object SequenceParser10 {
  /** Implicit [[smd.parsing.SequencingHeuristic]] which can be used to combine an [[smd.parsing.SequenceParser10]]
    * and an [[smd.parsing.Parser]] into an [[smd.parsing.SequenceParser11]]. */
  implicit def sequencingHeuristic[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, A]: SequencingHeuristic[
    /*  left: */ SequenceParser10[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10],
    /* right: */ Parser[A],
    /*  dest: */ SequenceParser11[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, A]
  ] =
    SequencingHeuristic.create((l, r) => SequenceParser11(l._1, l._2, l._3, l._4, l._5, l._6, l._7, l._8, l._9, l._10, r))
}